            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('front.homepage') }}"> <img src="{{asset('uploads/settings')."/$settings->logo"}}"
                                alt="logo"> </a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        @foreach ($category as $c )
                                            <a class="dropdown-item" href="{{ route('front.category' , $c->id) }}">{{ $c->name }}</a>
                                        @endforeach
                                    </div>
                                </li>
                                <li class="nav-item">
