            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item">
                        <h2>Our Courses</h2>
                        <p>Home<span>/</span>Courses<span>/</span>{{ $course->category->name }}<span>/</span>{{ $course->name }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 right-contents">
                ...
                <!--Applying to the course start part-->
                <div class="my-5">
                    @include('front.include.errors')
                    <form class="form-contact contact_form" action="{{ route('front.forms.enroll') }}" method="post" id="contactForm" novalidate="novalidate">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control" name="specialize" type="text" onfocus="this.placeholder =''" onblur="this.placeholder = 'Enter your speciality' placeholder='Enter your speciality'>
                                </div>
                            </div>
                        </div>
                ...
                <!--Applying to the course end part-->
            </div>
        </div>
    </div>
</section>
